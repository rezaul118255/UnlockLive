        ...
        <div className="grid grid-cols-1 gap-32 md:grid-cols-2 mt-20">
            <div className="text-[#270A05]">
                <div className="mt-[450px] md:mt-0">
                    ...
                    <p className="ValueSansPro text-[16px] mt-4 leading-[27px]">Unlocklive takes pride in the art of roasting, transforming raw coffee beans into a symphony of aromatic notes and rich flavors.</p>
                </div>
                <div className="flex-1 md:flex gap-4 mt-4 ">
                    <div className="h-[143px] w-[203px] border border-[#270A05] ">
                    ...
                    <div className="h-[143px] w-[203px] border mt-6 md:mt-0 border-[#270A05] ">
                ...
                <h1 className="mt-8 ValueSansPro text-[16px]  leading-[27px]">Your choice to savor our coffee is an invitation to experience the epitome of craftsmanship, flavor, and dedication.</h1>
